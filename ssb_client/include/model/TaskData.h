...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_TaskData_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_TaskData_H_
...
///
/// </summary>
class TaskData : public ModelBase {
 public:
  TaskData();
  virtual ~TaskData();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_TaskData_H_ */
