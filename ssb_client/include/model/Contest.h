...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Contest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Contest_H_
...
///
/// </summary>
class Contest : public ModelBase {
 public:
  Contest();
  virtual ~Contest();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Contest_H_ */
