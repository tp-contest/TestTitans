...
web::json::value ContestData::toJson() const {
...
void ContestData::fromJson(const web::json::value& val) {
...
void ContestData::toMultipart(std::shared_ptr<MultipartFormData> multipart,
...
void ContestData::fromMultiPart(std::shared_ptr<MultipartFormData> multipart,
...
void ContestData::setUserId(int32_t value) { m_User_id = value; }

int32_t ContestData::getInputFileId() const { return m_Input_file_id; }

void ContestData::setInputFileId(int32_t value) { m_Input_file_id = value; }

int32_t ContestData::getOutputFileId() const { return m_Output_file_id; }

void ContestData::setOutputFileId(int32_t value) { m_Output_file_id = value; }

int32_t ContestData::getDescriptionFileId() const {
  return m_Description_file_id;
}

void ContestData::setDescriptionFileId(int32_t value) {
