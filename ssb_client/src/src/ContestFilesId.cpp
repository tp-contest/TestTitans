...
web::json::value ContestFilesId::toJson() const {
...
void ContestFilesId::fromJson(const web::json::value& val) {
...
void ContestFilesId::toMultipart(std::shared_ptr<MultipartFormData> multipart,
...
void ContestFilesId::fromMultiPart(std::shared_ptr<MultipartFormData> multipart,
...
void ContestFilesId::setInputFileId(int32_t value) { m_Input_file_id = value; }

int32_t ContestFilesId::getOutputFileId() const { return m_Output_file_id; }

void ContestFilesId::setOutputFileId(int32_t value) {
...
void ContestFilesId::setDescriptionFileId(int32_t value) {
