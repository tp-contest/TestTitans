...
SchedulerApi::SchedulerApi(std::shared_ptr<ApiClient> apiClient)
    : m_ApiClient(apiClient) {}

SchedulerApi::~SchedulerApi() {}

pplx::task<void> SchedulerApi::sendTask(
  ...
  utility::string_t localVarPath =
      utility::conversions::to_string_t("/scheduler/sendTask");
  ...
  // multipart formdata
    ...
    throw ApiException(400, utility::conversions::to_string_t(
                                "SchedulerApi->sendTask does not produce any "
  ...
  // multipart formdata
    ...
    throw ApiException(415, utility::conversions::to_string_t(
                                "SchedulerApi->sendTask does not consume any "
                                "supported media type"));
  }
