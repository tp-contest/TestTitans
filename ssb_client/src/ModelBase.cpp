...
std::shared_ptr<HttpContent> ModelBase::fileFromJson(
...
std::shared_ptr<std::istream> ModelBase::fromBase64(
...
utility::string_t ModelBase::stringFromHttpContent(
...
utility::datetime ModelBase::dateFromHttpContent(
    std::shared_ptr<HttpContent> val) {
  utility::string_t str = ModelBase::stringFromHttpContent(val);
...
web::json::value ModelBase::valueFromHttpContent(
    std::shared_ptr<HttpContent> val) {
  utility::string_t str = ModelBase::stringFromHttpContent(val);
